function main() {
  ...
  const getBook = () => {
    ...
    // //membuat inntance dari XMLHttpRequest
  ...
  const insertBook = async (book) => {
    ...
    // // Membuat POST request dan menetaplan target URL
  ...
  const updateBook = async (book) => {
    ...
    // // menetapakan callback jika response success dan error
    // xhr.onload = function () {
    //   const responseJson = JSON.parse(this.responseText);
    //   showResponseMessage(responseJson.message);
    //   getBook();
    ...
    // // Membuat PUT request dan menetapkan url
  ...
  const removeBook = async (bookId) => {
    ...
    // // Mementapkan properti X-Auth-Token pada Header request
    // xhr.setRequestHeader("X-Auth-Token", "12345");
